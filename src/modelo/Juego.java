...
public class Juego {
    ...
    public void guardar() {
        System.out.println("Guardar no implementado: este proyecto de momento no usa archivos.");
    }

    public void cargar() {
        System.out.println("Cargar no implementado: este proyecto de momento no usa archivos.");
    }
