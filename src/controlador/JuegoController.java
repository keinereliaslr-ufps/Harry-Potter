...
public class JuegoController {
    ...
    public JuegoController() {
        this.juego = new Juego("Hogwarts Legacy POO1");
    ...
    public void guardarJuegoStub() {
        juego.guardar();
        JOptionPane.showMessageDialog(null, "Guardar no implementado (sin archivos).", "Info", JOptionPane.INFORMATION_MESSAGE);
    }

    public void cargarJuegoStub() {
        juego.cargar();
        JOptionPane.showMessageDialog(null, "Cargar no implementado (sin archivos).", "Info", JOptionPane.INFORMATION_MESSAGE);
    }
}
